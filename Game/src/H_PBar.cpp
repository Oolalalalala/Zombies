...
H_PBar::H_PBar(Ref<Scene> scene)
{
	...
	transform1.Position = { 2400, 300, 2400 };
...
{
	PresentBar.GetComponent<SpriteRendererComponent>().Size=glm::vec2{ hp * 0.07, 70.f }; // AddComponent 賦予性質
	OriginBar.GetComponent<SpriteRendererComponent>().Size = glm::vec2{ 700-(hp * 0.07), 70.f };
...
{
	hp -= damage;
	hp = glm::clamp(hp, -100.0f, 10000.0f);
}
